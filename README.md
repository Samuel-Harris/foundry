...
| Type    | Name                              | Description                                                                    |
| :------ | :-------------------------------- | :----------------------------------------------------------------------------- |
| Command | `handoff`                         | Create a comprehensive AI context handoff document for long-running sessions.  |
| Command | `git-diff/all-changes-main`       | Show all changes between the current branch and the merge base of origin/main. |
...
- Primer logo generated with Gemini nano banana.
