...
Before any analysis, gather context with parallel reads and searches:

1. **Codebase structure** — search the codebase to understand project layout
2. **Related code** — search and read to find relevant implementations
