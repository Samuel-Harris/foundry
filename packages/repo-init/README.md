...
Scaffold a new repository or monorepo with evidence-based agent guidance.
...
```bash
apm install Samuel-Harris/foundry/packages/repo-init#v0.1.0 --target cursor,claude,copilot
```
