...
- If the intended behaviour, design, constraints, or success criteria are ambiguous, stop and use `/deep-interview` before finalising the plan.
...
Before you finish a plan, ask: could another agent implement this without guessing about the core intent, intended behaviour, or design? If not, the plan is incomplete.
