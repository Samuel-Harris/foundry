...
- The prose anchor **[N]** must always appear _before_ the code snippet containing its matching `<!--ref:N-->`
...
- Use unified diff format with `+` and `-` prefixes for added and removed lines
